        ...
        <div className="grid lg:grid-cols-[1.05fr_1.45fr]">
          <aside className="relative overflow-hidden bg-emerald-900 p-8 text-white sm:p-10">
            ...
            <div className="relative z-10">
              <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-3 py-1.5 text-xs font-semibold uppercase tracking-[0.2em] text-emerald-100"></div>
